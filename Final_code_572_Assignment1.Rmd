...
---
#Author: Taniya Rajani, Yuvika Rajrana and Pragna Venigella

```{r}
# setwd("D:/IDS 572/Assgn 1/lcData6m")
library(ggplot2)
library(dplyr)
library(lubridate)
library(caret)
...
# Question 4 - Develop decision tree models to predict default.
```{r}
#Decision tree model
library(rpart)
library(rpart.plot)
...
# Question 5 - Develop a random forest model.
